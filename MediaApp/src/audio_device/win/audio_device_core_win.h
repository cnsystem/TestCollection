...
#ifndef WEBRTC__AUDIO_DEVICE_AUDIO_DEVICE_CORE_WIN_H
#define WEBRTC__AUDIO_DEVICE_AUDIO_DEVICE_CORE_WIN_H
...
#pragma comWEBRTC_nt( lib, "avrt.lib" )
...
#endif  // WEBRTC__AUDIO_DEVICE_AUDIO_DEVICE_CORE_WIN_H
