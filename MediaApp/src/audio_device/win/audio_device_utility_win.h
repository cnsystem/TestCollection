...
#ifndef WEBRTC__AUDIO_DEVICE_AUDIO_DEVICE_UTILITY_WIN_H
#define WEBRTC__AUDIO_DEVICE_AUDIO_DEVICE_UTILITY_WIN_H
...
#endif  // WEBRTC__AUDIO_DEVICE_AUDIO_DEVICE_UTILITY_WIN_H
