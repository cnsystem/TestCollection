...
#ifndef WEBRTC__AUDIO_DEVICE_AUDIO_MIXER_MANAGER_WIN_H
#define WEBRTC__AUDIO_DEVICE_AUDIO_MIXER_MANAGER_WIN_H
...
#endif  // WEBRTC__AUDIO_DEVICE_AUDIO_MIXER_MANAGER_H
